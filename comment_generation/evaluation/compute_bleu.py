...
file_path = 'comment_generation_results_alltest.jsonl'
data = load_jsonl_file(file_path)
bleu = compute_bleu_score(data, 'reference', 'prediction') #genrated_comment : typo
print('### Initial dataset ###')
print(bleu)
file_path = 'comment_generation_results_codereviewer.jsonl'
data = load_jsonl_file(file_path)
bleu = compute_bleu_score(data, 'reference', 'prediction') #genrated_comment : typo
print('### Initial dataset2 ###')
print(bleu)
