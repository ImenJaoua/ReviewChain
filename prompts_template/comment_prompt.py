review_classification_system_prompt = """You are an expert in coding and code peer-reviewing. Your role is the Comment Generator.

"""

review_classification_template = """### Code review comment generation
Generate a review comment for the given code changes.
