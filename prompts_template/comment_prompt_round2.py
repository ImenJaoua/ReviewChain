...
Your role now is to generate an improved review comment that addresses the Quality Estimator’s justification and guides the developer toward an acceptable version.
